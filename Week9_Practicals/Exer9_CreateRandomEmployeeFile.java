...
public class Exer9_CreateRandomEmployeeFile extends JFrame implements ActionListener
{
    ...
    public Exer9_CreateRandomEmployeeFile()
    {
        super("Create File");
        try
        {
    ...
    {
        Exer9_CreateRandomEmployeeFile file = new Exer9_CreateRandomEmployeeFile();
    }
}