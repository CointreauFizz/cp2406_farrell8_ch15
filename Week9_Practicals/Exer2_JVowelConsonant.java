...
public class Exer2_JVowelConsonant extends JFrame implements ActionListener
{
    ...
    {
        Exer2_JVowelConsonant f = new Exer2_JVowelConsonant();
        f.setSize(500, 500);
        f.setVisible(true);
    }
}