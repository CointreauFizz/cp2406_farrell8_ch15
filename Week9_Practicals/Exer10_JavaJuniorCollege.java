...
public class Exer10_JavaJuniorCollege extends JFrame implements ActionListener
{
    ...
    public Exer10_JavaJuniorCollege()
    {
    ...
    {
        Exer10_JavaJuniorCollege frame = new Exer10_JavaJuniorCollege();
        final int WIDTH = 400;
