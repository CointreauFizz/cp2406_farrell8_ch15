...
public class Exer9_ReadRandomEmployeeFile extends JFrame implements ActionListener
{
    ...
    public Exer9_ReadRandomEmployeeFile()
    {
        try
        {
            empFile =
    ...
    {
        Exer9_ReadRandomEmployeeFile file = new Exer9_ReadRandomEmployeeFile();
    }
}